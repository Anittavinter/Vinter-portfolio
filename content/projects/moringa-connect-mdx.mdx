---
  title: Alumin App Moringa Connect
  summary: Moringa Connect.
  image: /images/projects/Alumin.jpeg
  author: 'vinter achien'
  publishedAt: '2024-09-19'
---

This is a Alumin App built with Figma, Framer, Relume and Adobe Illustrator. It uses the `React Native for development`
package to render MDX content in react native pages.
